        ...
        <div className="flex flex-col items-center justify-start gap-[1.5rem] mb-20 mt-20">
            ...
            <div className="flex flex-col items-start justify-start gap-[2.5rem]">
                ...
                <div className="relative rounded bg-bg shadow-[0px_1px_13px_rgba(0,_0,_0,_0.05)] w-[73.13rem] h-[6.38rem] overflow-hidden shrink-0">
                    ...
                    <div className="absolute top-[1.72rem] left-[44.28rem] rounded box-border w-[3.0rem] h-[2.94rem] overflow-hidden border-[1.5px] border-solid border-gray-200">
                        <div className="absolute top-[0.68rem] left-[0.85rem] w-[3rem] flex flex-row items-center justify-start gap-[1rem]">
                    ...
                    <div className="absolute top-[calc(50%_-_27px)] left-[calc(50%_-_545px)] w-[3.38rem] h-[3.38rem] overflow-hidden">
                        <img
                            ...
                            alt=""
                            src="https://www.jewelove.in/cdn/shop/products/jewelove-7-pointer-single-line-platinum-tennis-bracelet-with-diamonds-jl-ptb-646-single-si-ij-6691923329117.jpg?v=1680557765"
                        />
                    </div>
                    <div className="absolute top-[2.44rem] left-[7.13rem] leading-[1.5rem]">
                        White Gold Diamond y Bracelet                    </div>
                    <img
            ...
            <div className="items-start gap-[757px] inline-flex relative">
                ...
                <button className="w-50 h-14 px-12 py-4 rounded border border-black border-opacity-50 justify-center items-center gap-2.5 inline-flex">
                    <div className="text-black text-base font-medium leading-normal">Return to shop</div>
                </button>
                <button className="w-50 h-14 px-12 py-4 rounded border border-black border-opacity-50 justify-center items-center gap-2.5 inline-flex">
                    <div className="text-black text-base font-medium leading-normal">Update Cart</div>
                </button>
            </div>
            ...
            <div className="flex flex-row items-start justify-start gap-[10.81rem]">
                <div className="flex flex-row items-end justify-start gap-[1rem]">
                    ...
                    <div className="w-52 h-14 px-12 py-4 bg-red-500 rounded justify-center items-center gap-2.5 inline-flex">
                        <div className="text-neutral-50 text-base font-medium leading-normal">Apply Coupon</div>
                    </div>
                </div>
                <div className="relative rounded box-border w-[29.38rem] h-[20.25rem] overflow-hidden shrink-0 border-[1.5px] border-solid border-text2">
                    ...
                    <button className="absolute top-[14.75rem] left-[5.56rem] rounded bg-button2 flex flex-row py-[1rem] px-[3rem] items-center justify-center text-text">
